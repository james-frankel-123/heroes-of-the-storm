...
public sealed class OnnxSessions : IDisposable
{
    ...
    public OnnxSessions(string policyPath, string gdPath, string wpPath)
    {
    ...
    /// <summary>Convenience factory: point at a folder containing the three .onnx files.</summary>
